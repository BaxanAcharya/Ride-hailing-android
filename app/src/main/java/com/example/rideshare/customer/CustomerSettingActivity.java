...
public class CustomerSettingActivity extends AppCompatActivity {
    ...
    private String databaseUser, databasePhone, databaseImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReferenceCustomer = FirebaseDatabase.getInstance()
    ...
    private void getUserInfo() {
        databaseReferenceCustomer.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CustomerSettingActivity.this, "" + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveUserInformation() {
        ...
        databaseReferenceCustomer.updateChildren(userInfo);
        if (resultUri!=null){
                        ...
                        if (taskSnapshot.getMetadata().getReference() != null) {
                            ...
                            result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    databaseReferenceCustomer.updateChildren(newImage);
                                    finish();
                                    return;
                                }
                            });
